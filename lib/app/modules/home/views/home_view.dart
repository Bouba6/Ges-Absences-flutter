            ...
            children: [
              ...
              TextField(
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.search, color: primaryDark.withOpacity(0.7)),
                  suffixIcon: Obx(
                    () =>
                        controller.loadingEleve.value
                            ...
                            : Icon(Icons.person_search, color: primaryDark.withOpacity(0.7)),
                  ),
                                ...
                                controller.validatingPresence.value
                                    ...
                                    : () {
                                      final String eleveId =
                                          eleve.id.toString();
                                      final String idVigile =
                                          '6839861414d219133e656d7e';
            ...
            if (controller.error.value.isNotEmpty) {
              return Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.error_outline, size: 64, color: primaryOrange.withOpacity(0.7)),
                    const SizedBox(height: 16),
                    Text(
            ...
            if (controller.eleves.isEmpty) {
              return Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.people_outline, size: 64, color: primaryDark.withOpacity(0.5)),
                    const SizedBox(height: 16),
                    Text(
                      'Aucun élève trouvé',
                      style: TextStyle(
